...
async def next_page(bot, query):
    ...
    if SINGLE_BUTTON:
        btn = [
           ...
           [
                  InlineKeyboardButton('ɪɴꜰᴏ', url=f'⚠️ ɪɴꜰᴏʀᴍᴀᴛɪᴏɴ ⚠️\n\nɪꜰ ʏᴏᴜ ᴅᴏ ɴᴏᴛ ꜱᴇᴇ ᴛʜᴇ ʀᴇǫᴜᴇꜱᴛᴇᴅ ᴍᴏᴠɪᴇ / ꜱᴇʀɪᴇꜱ ꜰɪʟᴇ, ʟᴏᴏᴋ ᴀᴛ ᴛʜᴇ ɴᴇxᴛ ᴘᴀɢᴇ \n\n© ғɪʟᴍʏ ʜᴀʀʙᴏᴜʀ', show_alert=True),
                  InlineKeyboardButton('ᴍᴏᴠɪᴇ', url=f"∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙\nᴍᴏᴠɪᴇ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ\n∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙\nɢᴏ ᴛᴏ ɢᴏᴏɢʟᴇ ➠ ᴛʏᴘᴇ ᴍᴏᴠɪᴇ ɴᴀᴍᴇ ➠ ᴄᴏᴘʏ\nᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ ➠ ᴘᴀꜱᴛ ᴛʜɪꜱ ɢʀᴏᴜᴘ \n\nᴇxᴀᴍᴘʟᴇ : ᴍɪɴɴᴀʟ ᴍᴜʀᴀʟɪ ᴏʀ ᴍɪɴɴᴀʟ ᴍᴜʀᴀʟɪ 2021 \n\n🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)\n\n© ғɪʟᴍʏ ʜᴀʀʙᴏᴜʀ", show_alert=True),
                  InlineKeyboardButton('ꜱᴇʀɪᴇꜱ', url=f"∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙\nꜱᴇʀɪᴇꜱ ʀᴇǫᴜᴇꜱᴛ ꜰᴏʀᴍᴀᴛ\n∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙∙\nɢᴏ ᴛᴏ ɢᴏᴏɢʟᴇ ➠ ᴛʏᴘᴇ ꜱᴇʀɪᴇꜱ ɴᴀᴍᴇ ➠ ᴄᴏᴘʏ\nᴄᴏʀʀᴇᴄᴛ ɴᴀᴍᴇ ➠ ᴘᴀꜱᴛ ᴛʜɪꜱ ɢʀᴏᴜᴘ \n\nᴇxᴀᴍᴘʟᴇ : ᴅᴀʀᴋ ᴏʀ ᴅᴀʀᴋ ꜱ01ᴇ01\n\n🚯 ᴅᴏɴᴛ ᴜꜱᴇ ➠ ':(!,./)\n\n© ғɪʟᴍʏ ʜᴀʀʙᴏᴜʀ", show_alert=True)
           ],[
    ...
    if n_offset == 0:
        btn.append(
            [InlineKeyboardButton("⌫ 𝐁𝐀𝐂𝐊", callback_data=f"next_{req}_{key}_{off_set}"), InlineKeyboardButton(f"📃 Pages {round(int(offset)/10)+1} / {round(total/10)}", callback_data="pages")]
        )
